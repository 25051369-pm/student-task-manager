...
export const Dashboard = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 md:p-8 min-h-screen relative z-10">
      ...
      <AnimatePresence>
        {showTaskForm && (
          ...
          >
            <form onSubmit={handleCreateTask} className="bg-panelBg border border-neonCyan/30 p-6 shadow-[inset_0_0_20px_rgba(0,243,255,0.05)] flex flex-col md:flex-row gap-4 items-end">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex flex-col md:flex-row gap-6 overflow-x-auto pb-10 min-h-[60vh] items-stretch">
          {columns.map(status => (
            <div key={status} className="flex-1 min-w-[320px] flex flex-col bg-panelBg backdrop-blur-xl p-5 border-t-2 border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] relative group">
